...
def parse_deformation_graph(graph_type):
    if graph_type == 'full_multiple_gaussians_68':
        adjacency_array = np.array(_get_complete_directed_graph_edges(range(68)))
        root_vertex = None
    elif graph_type == 'full_multiple_gaussians_66':
        adjacency_array = np.array(_get_complete_directed_graph_edges(range(66)))
        root_vertex = None
    elif graph_type == 'full_multiple_gaussians_tri_68':
        adjacency_array = np.array(_get_complete_graph_edges(range(68)))
        root_vertex = None
    elif graph_type == 'full_multiple_gaussians_tri_66':
        adjacency_array = np.array(_get_complete_graph_edges(range(66)))
        root_vertex = None
        ...
        nose1 = _get_chain_graph_edges(range(27, 34))
...
def parse_appearance_graph(graph_type):
    if graph_type == 'full_single_gaussian':
        ...
        gaussian_per_patch = False
    elif graph_type == 'full_multiple_gaussians_68':
        adjacency_array = np.array(_get_complete_graph_edges(range(68)))
